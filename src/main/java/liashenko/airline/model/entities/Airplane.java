...
//abstract airplane (first level of the aircraft hierarchy)
public abstract class Airplane implements FlightHaul, Serializable, Cloneable {

    protected Long serialNumber;
    protected String modelName;
    protected String producer;
    protected FlightHaul.HAULS haulType;
    ...
    public String getDescription() {
        ...
        sb.append(String.format(" | haul type : %-15s", haulType));
