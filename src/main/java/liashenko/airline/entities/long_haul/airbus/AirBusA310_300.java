package liashenko.airline.entities.long_haul.airbus;

import liashenko.airline.entities.long_haul.LongHaul;
import liashenko.airline.entities.producers.AirBus;

public class AirBusA310_300 extends AirBus implements LongHaul {

    private static final long serialVersionUID = 1L;

    public AirBusA310_300() {
        this.modelName = "A-310-300";
        this.flightRange = validateFlightRange(11_000);
        this.carryingCapacity = 33_550;
        this.maxFlightHeight = 12_200;
        this.cruiseSpeed = 858;
        this.fuelConsumption = 4_700;
    }
    ...
    @Override
    public AirBusA310_300 clone() throws CloneNotSupportedException {
        return (AirBusA310_300) super.clone();
    }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof AirBusA310_300)) return false;

        AirBusA310_300 airplane = (AirBusA310_300) o;
